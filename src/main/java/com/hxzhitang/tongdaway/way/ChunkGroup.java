...
import static com.hxzhitang.tongdaway.Tongdaway.*;
                ...
                if (protoChunk.getStatus() == ChunkStatus.EMPTY) {
                    ...
                    heightMapLoadPoolExecutor.submit(() -> {
                        ...
                        res.forEach((key, value) -> {
                            ...
                            if (Config.features.contains(structureName)) {
                                //连接配置文件连接遗迹名单
                                wayMap.setStructureNode(pos, structureName);
                            } else if (Config.alwaysConnectVillage && structureName.contains("village")) {
                                //一定连接村庄
                                wayMap.setStructureNode(pos, structureName);
                            }
                        });
