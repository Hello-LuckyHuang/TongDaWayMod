...
//        TongDaWay.LOGGER.info("====> CrossPlanner: {} {} {} {}", (int)t.x, (int)t.y, (int)t.z, regionPos);
    ...
    private List<Vec3> assignCross(List<CrossGenInfo> cross) {
        ...
        result.add(copy.get(0).placePos.getCenter()); //z最小 北
        result.add(copy.get(copy.size() - 1).placePos.getCenter());  //z最大 南
        ...
        result.add(copy.get(0).placePos.getCenter());  //x最小 西
        result.add(copy.get(copy.size() - 1).placePos.getCenter());  //x最大 东
